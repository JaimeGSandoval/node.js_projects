...
router.post(
  ...
  async (req, res) => {
    ...
    // END OF DEFINE & GUARD CLAUSE SECTION
    ...
    // Do not include sensitive information in JWT such as passwords/emails
    // because other people can actually decode the info back to the original
    // values.
    // It's recommended to only user data such a username, first name and/or last name etc. Email is used here just for demonstration purposes
...
router.post('/login', async (req, res) => {
  ...
  // Set refersh token in refreshTokens array aka DB
